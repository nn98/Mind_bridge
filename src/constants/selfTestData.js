...
중등도 수준의 우울을 방치하면 더 악화될 수 있습니다. 자존감이 낮아지고, 자신을 비난하는 생각이 반복되는 패턴에 굳어질 수 있지요. 일상에서 할 수 있는 작은 변화라도 천천히 실천하며 전문가의 도움을 받는 것이 중요합니다. 가능한 빨리 전문가를 찾아가 채팅을 받으시길 권해 드립니다.`,
                categories: {
                    '전문가 채팅 고려하기': [
                        '인지행동치료(CBT)를 통해 부정적인 사고 패턴 변화시키기',
                        '채팅사와의 대화를 통해 감정을 객관적으로 조망하기'
                    ],
                    '일상적인 루틴 회복 노력': [
            ...
            },
            {
                ...
                categories: {
                    '긴급 개입 필요': [
                        '정신건강의학과 전문의 채팅 즉시 필요',
                        '가까운 정신건강센터 또는 채팅전화(1577-0199) 연결'
                    ],
                    '가족 및 지지체계 활용': [
