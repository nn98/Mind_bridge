        ...
        <div className="help-page">
            ...
            <section className="help-card hero">
                ...
                <div className="help-actions">
                    <button className="help-btn" type="button" onClick={() => open("terms")}>
                        이용약관 보기
                    </button>
                    <button className="help-btn" type="button" onClick={() => open("privacy")}>
                        개인정보처리방침 보기
                    </button>
                </div>
            </section>
            ...
            {/* ───────────── 모달 (내장) ───────────── */}
            {activeModal && (
                <div className="hp-modal-backdrop" onClick={close} role="dialog" aria-modal="true">
                    <div
                        className="hp-modal"
                        onClick={(e) => e.stopPropagation()}
                        aria-labelledby="hp-modal-title"
                    >
                        <button className="hp-modal-close" aria-label="닫기" onClick={close}>
                            ×
                        </button>

                        <h3 id="hp-modal-title" className="hp-modal-title">
