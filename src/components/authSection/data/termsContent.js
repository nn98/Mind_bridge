...
1. '서비스'라 함은 회사가 제공하는 AI 채팅, 감정 분석, 이미지 테라피 등 모든 서비스를 의미합니다.
2. '회원'이라 함은 회사의 서비스에 접속하여 본 약관에 따라 회사와 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 고객을 말합니다.
3. 'AI 채팅'이라 함은 인공지능 기술을 활용하여 사용자의 심리적 상태를 분석하고 조언을 제공하는 비대면 채팅 서비스를 의미합니다.
...
1. 회사는 다음과 같은 업무를 수행합니다.
   - AI 기반 심리 채팅 및 분석 서비스
   - 심리 치유를 위한 이미지 테라피 콘텐츠 제공
   - 기타 회사가 정하는 관련 업무
2. 본 서비스는 의료 행위가 아니며, 진단이나 처방을 제공하지 않습니다. 심각한 정신 건강 문제가 의심될 경우, 반드시 전문 의료기관과 채팅하시기 바랍니다.
