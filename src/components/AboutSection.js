...
const AboutSection = ({ refs, scrollTarget, setScrollTarget, setIsEmotionModalOpen }) => {
  ...
  useEffect(() => {
    ...
    function drawChart() {
      if (!document.getElementById('monthly_chart')) return;
          ...
          <div className="card2">
            <form className="contact-form" onSubmit={(e) => {
              ...
              <div className="row-two">
                <div className="form-group"><label htmlFor="name">이름</label><input id="name" type="text" name="name" required /></div>
                <div className="form-group"><label htmlFor="email">이메일</label><input id="email" type="email" name="email" required /></div>
              </div>
              <div className="form-group"><label htmlFor="title">제목</label><input id="title" type="text" name="title" required /></div>
