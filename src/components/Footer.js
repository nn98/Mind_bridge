...
| 구분 | 수집 항목 | 수집 목적 |
| **회원가입 시** | (필수) 이메일 주소, 비밀번호, 닉네임<br>(선택) 프로필 사진, 이름 | 회원 식별, 공지사항 전달, 고객 문의 응대 |
| **SNS 간편 로그인 시** | (필수) [카카오: 닉네임, 프로필 사진, 이메일]<br>[구글: 이름, 이메일 주소, 프로필 사진] | 간편 로그인 기능 제공, 회원 식별 |
| **유료 서비스 이용 시** | 신용카드 정보, 통신사 정보 등 결제에 필요한 정보 | 요금 결제 및 정산 |
| **고객센터 이용 시** | 이메일, 휴대폰 번호, 문의 및 상담 내용 | 본인 확인, 문의사항 확인 및 처리 결과 통보 |
| **서비스 이용 과정** | IP 주소, 쿠키, 서비스 이용 기록, 기기정보(OS, 모델명) | 부정 이용 방지, 비인가 사용 방지, 서비스 품질 개선 |
