...
const resourceData = {
    우울증: {
        ...
        content: [
            ...
            },
            {
                ...
                text:
                    "혼자 해결하려 하지 않고 전문가의 도움을 받는 것이 중요합니다. 정신건강의학과 방문을 통해 정확한 진단을 받고, 채팅 치료나 약물 치료를 병행하는 것이 효과적입니다. 또한 규칙적인 생활 습관, 가벼운 운동, 햇볕 쬐기 등도 증상 완화에 도움이 됩니다.",
            },
        ],
        recommendations: [
            {title: "죽고 싶지만 떡볶이는 먹고 싶어", author: "백세희", description: "가벼운 우울감을 겪는 이들에게 큰 공감과 위로를 주는 채팅 에세이."},
    ...
    ADHD: {
        ...
        content: [
            ...
            {heading: "대처 방법", text: "약물 치료가 충동성과 집중력 조절에 효과적입니다. 채팅을 통해 시간관리/계획/감정 조절 스킬을 훈련하면 일상 기능 향상에 큰 도움이 됩니다."},
        ],
        recommendations: [
    ...
    "게임 중독": {
        ...
        content: [
            ...
            {heading: "대처 방법", text: "문제 인식 → 구체적 목표(주/일/회) 설정 → 대체 취미 탐색. 혼자 조절 어렵다면 채팅·치료 기관 도움을 받는 것이 가장 효과적입니다."},
        ],
        recommendations: [
